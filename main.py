...
def card(parent, title):
    ...
    tk.Label(outer, text=title, font=("Microsoft YaHei", 13, "bold"),
...
def info_row(parent, label, value=""):
    ...
    tk.Label(row, text=label, font=("Microsoft YaHei", 12), fg=COLORS["dim"],
             bg=COLORS["card"], width=14, anchor=tk.W).pack(side=tk.LEFT)
    val = tk.Label(row, text=value, font=("Microsoft YaHei", 12), fg=COLORS["text"],
...
def usage_bar(parent, label):
    ...
    pct_lbl = tk.Label(row, text="0%", font=("Microsoft YaHei", 12), fg=COLORS["text"],
...
class SysInfoApp:
    ...
    def _build_ui(self):
        ...
        tk.Label(toolbar, text="SysInfo Tool", font=("Microsoft YaHei", 16, "bold"),
        ...
        for name in ("实时监控", "监控记录"):
            btn = tk.Label(self.tab_btn_frame, text=name, font=("Microsoft YaHei", 12),
        ...
        self.hw_status = tk.Label(self.hw_body, text="正在检测硬件...",
                                  font=("Microsoft YaHei", 12), fg=COLORS["dim"], bg=COLORS["card"])
        ...
        self.rec_btn = tk.Button(rec_toolbar, text="开始记录", font=("Microsoft YaHei", 12),
        ...
        tk.Label(rec_toolbar, text="采样间隔:", font=("Microsoft YaHei", 12),
        ...
        tk.Button(rec_toolbar, text="清空", font=("Microsoft YaHei", 12),
                  command=self._clear_records).pack(side=tk.RIGHT, padx=8, pady=8)
        tk.Button(rec_toolbar, text="导出CSV", font=("Microsoft YaHei", 12),
        ...
        style.configure("Treeview", background=COLORS["card"], foreground=COLORS["text"],
                        fieldbackground=COLORS["card"], font=("Microsoft YaHei", 11))
        style.configure("Treeview.Heading", background=COLORS["tab_inactive"],
                        foreground=COLORS["text"], font=("Microsoft YaHei", 11, "bold"))
        ...
        tk.Label(ai_card, text="AI 分析", font=("Microsoft YaHei", 13, "bold"),
                 fg=COLORS["section"], bg=COLORS["card"]).pack(anchor=tk.W, padx=12, pady=(8, 2))
        ...
        tk.Label(ai_cfg, text="API地址:", font=("Microsoft YaHei", 11),
                 fg=COLORS["dim"], bg=COLORS["card"]).pack(side=tk.LEFT)
        self._ai_cfg = load_config()

        self.ai_url_entry = tk.Entry(ai_cfg, font=("Microsoft YaHei", 11), width=30,
        ...
        tk.Label(ai_cfg, text="API Key:", font=("Microsoft YaHei", 11),
                 fg=COLORS["dim"], bg=COLORS["card"]).pack(side=tk.LEFT)
        self.ai_key_entry = tk.Entry(ai_cfg, font=("Microsoft YaHei", 11), width=24,
                                     bg=COLORS["bar_bg"], fg=COLORS["text"], insertbackground=COLORS["text"],
                                     show="*")
        self.ai_key_entry.pack(side=tk.LEFT, padx=(2, 12))
        self.ai_key_entry.insert(0, self._ai_cfg["ai_key"])

        tk.Label(ai_cfg, text="模型:", font=("Microsoft YaHei", 11),
                 fg=COLORS["dim"], bg=COLORS["card"]).pack(side=tk.LEFT)
        self.ai_model_entry = tk.Entry(ai_cfg, font=("Microsoft YaHei", 11), width=16,
                                       bg=COLORS["bar_bg"], fg=COLORS["text"], insertbackground=COLORS["text"])
        ...
        self.ai_btn = tk.Button(ai_btn_frame, text="开始分析", font=("Microsoft YaHei", 12),
                                command=self._run_ai_analysis, bg=COLORS["accent"],
                                fg="#ffffff", relief=tk.FLAT, padx=12)
        self.ai_btn.pack(side=tk.LEFT, padx=0)

        self.ai_status_lbl = tk.Label(ai_btn_frame, text="", font=("Microsoft YaHei", 11),
        ...
        self.ai_response = tk.Text(ai_resp_frame, font=("Microsoft YaHei", 12),
        ...
        # Status bar
        self.status = tk.Label(self.root, text="就绪", font=("Microsoft YaHei", 11),
    ...
    def _display_hardware(self, data):
        ...
        for cpu in data["cpu"]:
            tk.Label(self.hw_body, text="CPU", font=("Microsoft YaHei", 13, "bold"),
        ...
        tk.Label(self.hw_body, text="GPU", font=("Microsoft YaHei", 13, "bold"),
        ...
        tk.Label(self.hw_body, text="内存", font=("Microsoft YaHei", 13, "bold"),
                 fg=COLORS["section"], bg=COLORS["card"]).pack(anchor=tk.W, pady=(10, 2))
        ...
        tk.Label(self.hw_body, text="硬盘", font=("Microsoft YaHei", 13, "bold"),
                 fg=COLORS["section"], bg=COLORS["card"]).pack(anchor=tk.W, pady=(10, 2))
    ...
    def _display_system(self, data):
        ...
        tk.Label(self.sys_body, text="网络适配器", font=("Microsoft YaHei", 13, "bold"),
